...
const ProjectHome = () => {
    ...
    const subMenuItems = [
        { key: '/project/tools/plugins', icon: <LogoutOutlined />, text: t('subMenuItemsTextPlugins'), path: `/project/tools/plugins` },
        { key: '/project/tools/actions', icon: <LogoutOutlined />, text: t('subMenuItemsTextActions'), path: `/project/tools/actions` },
    ];
    ...
    return (
        <Layout style={{ minHeight: '100vh', maxHeight: '100vh' }}>
            ...
            <Layout>
                        ...
                        <ConfigProvider theme={{
                            ...
                            <Menu onMouseEnter={handleMouseEnter}
                                ...
                                <Menu.Item key={`/project/home`} icon={<HomeIcon className="svg-icons" />}>
                                    <Link to={`/project/home`}>{t('projectHomeTitle')}</Link>
                                </Menu.Item>
                                <Menu.Item key={'/project/playground'} icon={<Playground className="svg-icons" />}>
                                    <Link to={'/project/playground'}>{t('projectPlaygroundTitle')}</Link>
                                </Menu.Item>
                                ...
                                <Menu.Item key={'/project/models'} icon={<IconData className="svg-icons" />}>
                                    <Link to={'/project/models'}>{t('projectModelTitle')}</Link>
                                </Menu.Item>
                                <Menu.Item key={'/project/collections'} icon={<Retrieval className="svg-icons" />}>
                                    <Link to={'/project/collections'}>{t('projectRetrievalTitle')}</Link>
                                </Menu.Item>
                                <Menu.Item key={'/project/tools'} icon={<Plugin className="svg-icons" />} onClick={handleSubMenu}>
                                    <Link to={'/project/tools'}>{t('projectToolsTitle')}</Link>
                                </Menu.Item>
                                ...
                                <Menu.Item key={`/project/assistants`} icon={<Assistant className="svg-icons" />}>
                                    <Link to={'/project/assistants'}>{t('projectAssistantsTitle')}</Link>
                                </Menu.Item>
                                ...
                                <Menu.Item key={'/project/apikeys'} className='api-key-menu' icon={<Apikeys className="svg-icons" />}>
                                    <Link to={'/project/apikeys'}>{t('projectAPIKeysTitle')}</Link>
                                </Menu.Item>

                                <Menu.Item icon={<Back className="svg-icons" />} onClick={handleBack} className='orgination' key='/'>
                                    <a onClick={handleBack}>{t('spaceLogoutTitle')}</a>
                                </Menu.Item>
                ...
                <Modal title={t('spaceLogoutTitle')} centered open={logoutOpen} closeIcon={<CloseIcon />}
